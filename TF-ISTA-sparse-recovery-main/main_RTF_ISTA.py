...
parser = ArgumentParser(description='Rescaled-Tight-Frame-ISTA')
...
print('Testing: my RTF-ISTA avg SNR is ', np.mean(SNR_list))
print('Testing: my RTF-ISTA std SNR is ', np.std(SNR_list))
print('Testing: my RTF-ISTA avg PES is ', PES_mean)
print('Testing: my RTF-ISTA std PES is ', PES_std)
...
sio.savemat(f'stored_results/RTF_ISTA_iter_{numIter}_noise_{noise_level:.3f}_sparsity_{sparsity}_sensing_{sensing}_vs_iterations', RSNR_dict)

output_file_name = f"./log/RTF_ISTA_iter_{numIter}_noise_{noise_level}_sparsity_{sparsity}_sensing_{sensing}_vs_iterations.txt"
